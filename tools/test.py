...
def parse_args():
    ...
    parser.add_argument("--config", help="train config file path",
                        default="/dinov2/rein_dinov2_mask2former_512x512_bs1x4.py")
    parser.add_argument("--checkpoint", help="rein and head checkpoint file",
                        default="/checkpoints/dinov2/SAWA_g2cbm_pretrained.pth")

    parser.add_argument("--backbone", help="backbone checkpoint file",
                        default="/data3/qinghua/qinghua_before/ZDJ/code/Rein_SAM/checkpoints/dinov2_converted.pth")
    parser.add_argument(
        "--work-dir",
        default="/checkpoints/dinov2/g2cbm/",
