...
class IDDDataset(Dataset):
    def __init__(self, root, transform=None, mode='train'):
        ...
        # 加载图像路径
        for city in os.listdir(img_dir):  # 遍历子文件夹 (如 0, 110, 147 等)
...
def save_results(combined_mask, img_path, mask_save_dir, label_save_dir):
    """Save combined_mask and label image."""
...
def main():
    ...
    # 定义路径
    data_dir = "/data3/qinghua/qinghua_before/UDA/data/IDD/"
    mask_save_dir = "/data2/qinghua/ZDJ/datasets/IDD_SAM/IDD_sam_val/idd_SAM_mask/"
    label_save_dir = "/data2/qinghua/ZDJ/datasets/IDD_SAM/IDD_sam_val/idd_SAM/"
    ...
    dataset = IDDDataset(data_dir, mode='val')  # 改为'val'或'train'模式
...
# CUDA_VISIBLE_DEVICES=0,1 python -m torch.distributed.launch --nproc_per_node=2 IDD_SAM.py
